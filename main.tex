...
\titlespacing*{\paragraph}{0pt}{1.25ex plus 0.1ex minus .0ex}{0.05em}
...
\end{abstract}
\begin{keywords}
    learning analytics, learning analytics dashboard, participatory design, co-design
\end{keywords}
\hrule\bigskip
...
\citet{prestigiacomo2020data} investigated the design of a human-centered workshop to explore the perspectives of two groups of pre-service teachers on the types of data that are important to them at this stage of their professional development. The participatory workshops were conducted in three stages: (1) Using generative design tools to explore the type of evidence and resources that these teachers use in their design of learning and teaching, and identify resources that are difficult to see in their current practice but that you would like to see; (2) Evidence ranking activity consisting in six stickers to classify according to importance for learning design and delivery. This aimed to investigate the reasons why the identified evidence and resources maybe valuable for teachers and how do the things they have identified connect to learning goals; and (3) Evidence-sharing phase to gather teachers' opinions on who should and should not have access to the evidence and why.
The findings suggest that academics responsible for teacher education need ongoing development to support their work in preparing for the mastery of student teacher data, the analysis of learning and the increasing presence of data analytics.
