...
In  software development, \textit{participatory design} can be thought of as a movement from end-users to the world of researchers and developers, while \textit{empathic design} is much more seen as a movement from researchers and developers to the world of end-users. 

The terms \textit{Participatory design} \textit{Co-design} are often used  interchangeably. Yet, Some authors make the distinction by stating that the term codesign has come more recently to denote a specific type of participatory design. For instance, \citet{szebeko2010co} state that "Co-design differs from some of these areas as it includes all stakeholders of an issue not just the users, throughout the entire process from research to implementation." For \citet{Sanders2008} "the terminology used until the recent obsession with what is now called co-creation/co-design" was "participatory design"
...
The tradition of participatory design suggests that successful design requires the “exchange between people who experience products, interfaces, systems and spaces and people who design for experiencing” (Sanders and Dandavate 1999, p. 90)
The main purpose is to empower participants to become legitimate and acknowledged members of the design team (Visser et al. 2005).
******************************************************
...
%persona profile, user journey, focus group, knowledge mapping and prototyping
